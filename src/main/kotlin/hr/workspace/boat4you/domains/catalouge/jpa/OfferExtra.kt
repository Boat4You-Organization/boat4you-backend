...
open class OfferExtra {
     ...
     * the sync mappers (MMK offers: `fromMmkOfferObligatory`; NauSys offers:
     * `fromNausysOfferObligatory` / `fromNausysCalculationType`). Drives the in-price / at-base split in
